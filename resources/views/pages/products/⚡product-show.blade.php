<?php
  ...
  new class extends Component {
    ...
    {
      return view('pages.products.⚡product-show');
    }
  };
?>
    ...
    <div class="lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-8">
      ...
      <div class="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0">
        ...
        <div class="mt-3">
          ...
          <p class="text-3xl tracking-tight text-gray-900">{{ $product->formatPrice() }}</p>
        </div>
          ...
          <div class="divide-y divide-gray-200 border-t border-gray-200">
            ...
            <div>
              ...
              <el-disclosure id="detail-2" hidden class="contents">
                <div class="pb-6">
                  <ul role="list" class="list-disc space-y-1 pl-5 text-sm/6 text-gray-700 marker:text-gray-300">
                    <li class="pl-2">{{ $product->shipping_information }}</li>
                    <li class="pl-2">{{ $product->warranty_information }}</li>
                    <li class="pl-2">{{ $product->return_policy }}</li>

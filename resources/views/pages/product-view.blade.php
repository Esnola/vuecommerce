    ...
    <div class="lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-8">
      ...
      <el-tab-group class="flex flex-col-reverse">
        ...
        <div class="mx-auto mt-6 hidden w-full max-w-2xl sm:block lg:max-w-none">
          <el-tab-list class="grid grid-cols-4 gap-6">
            <button class="relative flex h-24 cursor-pointer items-center justify-center rounded-md bg-white text-sm font-medium text-gray-900 uppercase hover:bg-gray-50 focus:ring-3 focus:ring-indigo-500/50 focus:ring-offset-4 focus:outline-hidden">
              ...
              <span aria-hidden="true"
                    class="pointer-events-none absolute inset-0 rounded-md ring-2 ring-transparent ring-offset-2 in-aria-selected:ring-indigo-500"></span>
            </button>
            <button class="relative flex h-24 cursor-pointer items-center justify-center rounded-md bg-white text-sm font-medium text-gray-900 uppercase hover:bg-gray-50 focus:ring-3 focus:ring-indigo-500/50 focus:ring-offset-4 focus:outline-hidden">
              <span class="sr-only">Front view</span>
              <span class="absolute inset-0 overflow-hidden rounded-md">
                <img src="https://tailwindcss.com/plus-assets/img/ecommerce-images/product-page-03-product-02.jpg"
                     alt="" class="size-full object-cover"/>
              </span>
              <span aria-hidden="true"
                    class="pointer-events-none absolute inset-0 rounded-md ring-2 ring-transparent ring-offset-2 in-aria-selected:ring-indigo-500"></span>
            ...
            <button class="relative flex h-24 cursor-pointer items-center justify-center rounded-md bg-white text-sm font-medium text-gray-900 uppercase hover:bg-gray-50 focus:ring-3 focus:ring-indigo-500/50 focus:ring-offset-4 focus:outline-hidden">
              ...
              <span class="absolute inset-0 overflow-hidden rounded-md">
                <img src="https://tailwindcss.com/plus-assets/img/ecommerce-images/product-page-03-product-03.jpg"
                     alt="" class="size-full object-cover"/>
              </span>
              <span aria-hidden="true"
                    class="pointer-events-none absolute inset-0 rounded-md ring-2 ring-transparent ring-offset-2 in-aria-selected:ring-indigo-500"></span>
            ...
            <button class="relative flex h-24 cursor-pointer items-center justify-center rounded-md bg-white text-sm font-medium text-gray-900 uppercase hover:bg-gray-50 focus:ring-3 focus:ring-indigo-500/50 focus:ring-offset-4 focus:outline-hidden">
              ...
              <span class="absolute inset-0 overflow-hidden rounded-md">
                <img src="https://tailwindcss.com/plus-assets/img/ecommerce-images/product-page-03-product-04.jpg"
                     alt="" class="size-full object-cover"/>
              </span>
              <span aria-hidden="true"
                    class="pointer-events-none absolute inset-0 rounded-md ring-2 ring-transparent ring-offset-2 in-aria-selected:ring-indigo-500"></span>
      ...
      <div class="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0">
        ...
        <div class="mt-6">
          ...
          <div class="space-y-6 text-base text-gray-700">
            <p>The Zip Tote Basket is the perfect midpoint between shopping tote and comfy backpack. With convertible
            ...
            <fieldset aria-label="Choose a color" class="mt-2">
              <div class="flex items-center gap-x-3">
                <div class="flex rounded-full outline -outline-offset-1 outline-black/10">
                  <input type="radio" name="color" value="washed-black" checked aria-label="Washed Black"
                         class="size-8 appearance-none rounded-full bg-gray-700 forced-color-adjust-none checked:outline-2 checked:outline-offset-2 checked:outline-gray-700 focus-visible:outline-3 focus-visible:outline-offset-3"/>
                </div>
                <div class="flex rounded-full outline -outline-offset-1 outline-black/10">
                  <input type="radio" name="color" value="white" aria-label="White"
                ...
                <div class="flex rounded-full outline -outline-offset-1 outline-black/10">
                  <input type="radio" name="color" value="washed-gray" aria-label="Washed Gray"
                         class="size-8 appearance-none rounded-full bg-gray-500 forced-color-adjust-none checked:outline-2 checked:outline-offset-2 checked:outline-gray-500 focus-visible:outline-3 focus-visible:outline-offset-3"/>
                </div>
              </div>
            </fieldset>
          </div>
        ...
        <section aria-labelledby="details-heading" class="mt-12">
          ...
          <div class="divide-y divide-gray-200 border-t border-gray-200">
            <div>
              <h3>
                <button type="button" command="--toggle" commandfor="detail-0"
                  ...
                  <span class="text-sm font-medium not-in-aria-expanded:text-gray-900 in-aria-expanded:text-indigo-600">Features</span>
                  <span class="ml-6 flex items-center">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon"
                         aria-hidden="true"
                         class="size-6 text-gray-400 group-hover:text-gray-500 in-aria-expanded:hidden">
                      <path d="M12 4.5v15m7.5-7.5h-15" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon"
                         aria-hidden="true"
                         class="size-6 text-indigo-400 not-in-aria-expanded:hidden group-hover:text-indigo-500">
                      <path d="M5 12h14" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                  </span>
                </button>
              </h3>
              <el-disclosure id="detail-0" class="contents">
                <div class="pb-6">
            ...
            <div>
              <h3>
                <button type="button" command="--toggle" commandfor="detail-1"
                        class="group relative flex w-full items-center justify-between py-6 text-left">
                  <span class="text-sm font-medium not-in-aria-expanded:text-gray-900 in-aria-expanded:text-indigo-600">Care</span>
                  <span class="ml-6 flex items-center">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon"
                         aria-hidden="true"
                         class="size-6 text-gray-400 group-hover:text-gray-500 in-aria-expanded:hidden">
              ...
              <el-disclosure id="detail-1" hidden class="contents">
                <div class="pb-6">
                  <ul role="list" class="list-disc space-y-1 pl-5 text-sm/6 text-gray-700 marker:text-gray-300">
                    <li class="pl-2">Spot clean as needed</li>
                    <li class="pl-2">Hand wash with mild soap</li>
                    <li class="pl-2">Machine wash interior dividers</li>
                    <li class="pl-2">Treat handle and tabs with leather conditioner</li>
                  </ul>
                </div>
              </el-disclosure>
            </div>
            <div>
              <h3>
                <button type="button" command="--toggle" commandfor="detail-2"
                        class="group relative flex w-full items-center justify-between py-6 text-left">
                  <span class="text-sm font-medium not-in-aria-expanded:text-gray-900 in-aria-expanded:text-indigo-600">Shipping</span>
                  <span class="ml-6 flex items-center">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon"
                         aria-hidden="true"
                         class="size-6 text-gray-400 group-hover:text-gray-500 in-aria-expanded:hidden">
              ...
              <el-disclosure id="detail-2" hidden class="contents">
                <div class="pb-6">
                  <ul role="list" class="list-disc space-y-1 pl-5 text-sm/6 text-gray-700 marker:text-gray-300">
                    <li class="pl-2">Free shipping on orders over $300</li>
                    <li class="pl-2">International shipping available</li>
                    <li class="pl-2">Expedited shipping options</li>
                    <li class="pl-2">Signature required upon delivery</li>
                  </ul>
                </div>
              </el-disclosure>
            </div>
            <div>
              ...
              <el-disclosure id="detail-3" hidden class="contents">
                <div class="pb-6">
                  <ul role="list" class="list-disc space-y-1 pl-5 text-sm/6 text-gray-700 marker:text-gray-300">
                    <li class="pl-2">Easy return requests</li>
                    <li class="pl-2">Pre-paid shipping label included</li>
                    <li class="pl-2">10% restocking fee for returns</li>
                    <li class="pl-2">60 day return window</li>
                  </ul>
                </div>
              </el-disclosure>
            </div>

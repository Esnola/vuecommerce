<?php
  ...
  new class extends Component {
    ...
    public function register(): void
    {
      ...
      session()->flash('registration-status', __('Your account has been created. Check your email to verify it.'));
  ...
  <div class="mx-auto w-full max-w-2xl">
    <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-xl dark:border-white/10 dark:bg-white/5 sm:p-8">
      <div class="flex flex-col gap-2 text-center">
        ...
        <flux:text>{{ __('Enter your details to request access.') }}</flux:text>
      </div>

  ...
  <footer class="bg-gray-800 dark:shadow-[0px_10px_15px_10px_rgba(204,204,204,0.3)] mt-20">
    <div class="mx-auto px-6 lg:px-8 py-20 sm:py-18 max-w-7xl overflow-hidden">
      <nav aria-label="Footer" class="flex flex-col items-center gap-y-1">
        ...
        <div class="flex flex-wrap justify-center gap-x-12 gap-y-3 text-sm/6">
          <a href="#" class="text-gray-400 hover:text-gray-300">About</a>
          <a href="#" class="text-gray-400 hover:text-gray-300">Blog</a>
          <a href="#" class="text-gray-400 hover:text-gray-300">Jobs</a>
          <a href="#" class="text-gray-400 hover:text-gray-300">Press</a>
          <a href="#" class="text-gray-400 hover:text-gray-300">Accessibility</a>
          <a href="#" class="text-gray-400 hover:text-gray-300">Partners</a>
        </div>
      </nav>
      ...
      <p class="mt-10 text-gray-400 hover:text-gray-300 text-sm/6 text-center">&copy; 2024 Your
